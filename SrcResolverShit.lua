...
ButtonUIGradient.Color = ColorSequence.new{
    ...
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(55, 0, 0))
}
...
NotificationFrame.Size = UDim2.new(0, 170, 0, 120)
...
NotificationTitle.Font = Enum.Font.Arcade
NotificationTitle.Text = "Literally OP bro"
...
NotificationText.Text = "Made By @eloisashaneMeh1"
